...
const createConfig = (props) => {
    ...
    config.supportedScanTypes = [Html5QrcodeScanType.SCAN_TYPE_CAMERA, Html5QrcodeScanType.SCAN_TYPE_FILE]
    config.focusMode = "continious"
    //config.advanced = [{zoom: 2.0}]
    config.experimentalFeatures = {useBarCodeDetectorIfSupported: true}

    return config;
};

const ScannerPlugin = (props) => {
